...
from hyperagent.trainer import gather_info, test_episode
from hyperagent.utils import BaseLogger, LazyLogger, MovAvg, tqdm_config
...
def offpolicy_trainer(
    ...
    :return: See :func:`~hyperagent.trainer.gather_info`.
    """
