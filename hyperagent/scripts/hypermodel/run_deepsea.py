...
from hyperagent.network import HyperModel
...
def get_args():
    ...
    parser.add_argument('--size', type=int, default=30, help="size of DeepSea-v0")
    ...
    parser.add_argument('--greedy-update', type=int, default=1, choices=[0, 1])
    ...
    # algorithm config
    parser.add_argument('--alg-type', type=str, default="HyperModel")
    ...
    parser.add_argument('--bias-init', type=str, default="sphere-sphere",
...
def main(args=get_args()):
    ...
    model = HyperModel(**model_params).to(args.device)
