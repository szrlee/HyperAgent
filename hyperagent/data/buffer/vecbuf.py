...
class VectorReplayBuffer(ReplayBufferManager):
    ...
    are the same as :class:`~hyperagent.data.ReplayBuffer`.

    .. seealso::

        Please refer to :class:`~hyperagent.data.ReplayBuffer` for other APIs' usage.
    """
...
class PrioritizedVectorReplayBuffer(PrioritizedReplayBufferManager):
    ...
    sample_avail) are the same as :class:`~hyperagent.data.PrioritizedReplayBuffer`.
