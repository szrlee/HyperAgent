...
from hyperagent.data import Batch
from hyperagent.data.batch import _alloc_by_keys_diff, _create_value
from hyperagent.data.utils.converter import from_hdf5, to_hdf5


class ReplayBuffer:
    """:class:`~hyperagent.data.ReplayBuffer` stores data generated from interaction \
